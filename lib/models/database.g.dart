...
class $CategoriesTable extends Categories
  ...
  late final GeneratedColumn<DateTime> updatedAt = GeneratedColumn<DateTime>(
      ...
      type: DriftSqlType.dateTime, requiredDuringInsert: true);
  static const VerificationMeta _delatedAtMeta =
      const VerificationMeta('delatedAt');
  @override
  late final GeneratedColumn<DateTime> delatedAt = GeneratedColumn<DateTime>(
      'delated_at', aliasedName, true,
      type: DriftSqlType.dateTime, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, type, createdAt, updatedAt, delatedAt];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Category> instance,
    ...
    if (data.containsKey('delated_at')) {
      context.handle(_delatedAtMeta,
          delatedAt.isAcceptableOrUnknown(data['delated_at']!, _delatedAtMeta));
    }
    return context;
  }
  ...
  Category map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Category(
      ...
      delatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}delated_at']),
    );
  }
...
class Category extends DataClass implements Insertable<Category> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || delatedAt != null) {
      map['delated_at'] = Variable<DateTime>(delatedAt);
    }
    return map;
  }
  ...
  CategoriesCompanion toCompanion(bool nullToAbsent) {
    return CategoriesCompanion(
      ...
      delatedAt: delatedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(delatedAt),
    );
  }
  ...
  factory Category.fromJson(Map<String, dynamic> json,
    ...
    return Category(
      ...
      delatedAt: serializer.fromJson<DateTime?>(json['delatedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'delatedAt': serializer.toJson<DateTime?>(delatedAt),
    };
  }
  ...
  Category copyWith(
          ...
          DateTime? createdAt,
          DateTime? updatedAt,
          Value<DateTime?> delatedAt = const Value.absent()}) =>
      Category(
        id: id ?? this.id,
        name: name ?? this.name,
        type: type ?? this.type,
        ...
        delatedAt: delatedAt.present ? delatedAt.value : this.delatedAt,
      );
  Category copyWithCompanion(CategoriesCompanion data) {
    return Category(
      ...
      delatedAt: data.delatedAt.present ? data.delatedAt.value : this.delatedAt,
    );
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, type, createdAt, updatedAt, delatedAt);
  @override
  bool operator ==(Object other) =>
      ...
      (other is Category &&
          ...
          other.delatedAt == this.delatedAt);
}
...
class CategoriesCompanion extends UpdateCompanion<Category> {
  ...
  final Value<DateTime?> delatedAt;
  const CategoriesCompanion({
    ...
    this.delatedAt = const Value.absent(),
  });
  ...
  static Insertable<Category> custom({
    ...
    return RawValuesInsertable({
      ...
      if (delatedAt != null) 'delated_at': delatedAt,
    });
  }
  ...
  CategoriesCompanion copyWith(
    ...
    return CategoriesCompanion(
      ...
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
      delatedAt: delatedAt ?? this.delatedAt,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (delatedAt.present) {
      map['delated_at'] = Variable<DateTime>(delatedAt.value);
    }
    return map;
  }
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  int get hashCode => Object.hash(id, name, category_id, transaction_date,
      amount, createdAt, updatedAt, delatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$CategoriesTableFilterComposer
  ...
  ColumnFilters<DateTime> get delatedAt => $state.composableBuilder(
      column: $state.table.delatedAt,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
}
...
class $$CategoriesTableOrderingComposer
  ...
  ColumnOrderings<DateTime> get delatedAt => $state.composableBuilder(
      column: $state.table.delatedAt,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
}
